...
export default function UpdateListing() {
    ...
    React.useEffect(() => {
        const fetchListing = async () => {
            const lisitngid = params.listingId;

            const res = await fetch(`http://localhost:3000/listing/get/${lisitngid}`, {
                credentials: 'include',
            });
        ...
        <>
            <div className='p-4 min-h-screen mt-20'>
                <main className='p-3 max-w-4xl mx-auto'>
                    <h1 className='text-3xl font-semibold text-center text-gray-800 my-7 uppercase'>
                        Update Listing
                    </h1>
